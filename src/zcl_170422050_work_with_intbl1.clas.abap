CLASS zcl_170422050_work_with_intbl1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170422050_work_with_intbl1 IMPLEMENTATION.
  ...
  ( carrier_id      = 'AA'
    ...
    connection = connections[ airport_from_id = 'SPO' airport_to_id = 'SIN' ].
