CLASS zcl_170422050_work_with_struct DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170422050_work_with_struct IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    SELECT SINGLE
      FROM /DMO/I_Connection
      FIELDS DepartureAirport AS ArrivalAirport,
             \_Airline-Name   AS carrier_name
      WHERE AirlineID = 'LH'
        AND ConnectionID = '0400'
